...
const Topbar = () => {
  return (
    <div className="md:hidden px-4">
      ...
      <button
        type="button"
        className="bg-gray-500 bg-opacity-20 hover:bg-opacity-30 text-sm text-textColor w-full py-2 font-medium rounded-md 
        border border-gray-300 border-opacity-20 hover:border-opacity-80 mt-4"
      >
        Edit profile
      </button>
    </div>
